...
5,x/=5,y*=5,da=1,f.forEach(function(a){a.speed*=5}),p.forEach(function(a){a.speed*=5}),k.forEach(function(a){a.speed*=5}),q.forEach(function(a){a.speed*=5}),W=!1);var a=function(){L=Math.floor(11*Math.random())};for(a();0==L&&"f"==M;)a();for(;4==L&&4E3>g;)a();for(;1==L&&1E3>g;)a();switch(L){case 0:M=(parseInt(M,16)+1).toString(16);h="PARTY HARDER!";break;case 1:d.speed+=0.5;f.forEach(function(a){a.speed+=0.5});m+=0.5;l+=0.5;r+=0.5;k.forEach(function(a){a.speed+=0.5});p.forEach(function(a){a.speed+=
